...
def issue_list(request):
    ...
    # at the moment for the lecturer am fectching all issues but after we set up lecturers with departments and courses well
    # we can further improve this query to filter depending on department or course
