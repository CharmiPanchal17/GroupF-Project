...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': [('log_issue', 'Can log an issue'), ('view_issue', 'Can view issues'), ('resolve_issue', 'Can resolve issues'), ('provide_feedback', 'Can provide feedback'), ('assign_issue', 'Can assign issues to lecturers'), ('oversee_issues', 'Can oversee all issues')],
            },
        ),
    ]
