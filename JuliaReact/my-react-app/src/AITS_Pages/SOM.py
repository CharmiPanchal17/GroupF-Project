...
class SimpleSOM:
    def __init__(self, adjacency_matrix):
        #Initialize Self Organizing Map for TSP
        ...
        for t in range(iterations):
            ...
            for city_idx in range(self.num_cities):
                ...
                for i in range(self.num_neurons):
                    ...
                    new_x = self.neurons[i][0] + current_lr * influence * (city_pos[0] - self.neurons[i][0])
                    new_y = self.neurons[i][1] + current_lr * influence * (city_pos[1] - self.neurons[i][1])
...
#Route found by SOM: [1, 3, 5, 7, 6, 4, 2, 1] 